...
export interface MockFtso extends BaseContract {
  constructor(
    jsonInterface: any[],
    address?: string,
  ...
  methods: {
    ...
    getEpochVotes(_epochId: number | string | BN): NonPayableTransactionObject<{
      _voters: string[];
      _prices: string[];
      _weights: string[];
      _weightsNat: string[];
      _weightsAsset: string[];
    ...
    getFullEpochReport(
      ...
      _epochSubmitStartTime: string;
      _epochSubmitEndTime: string;
      _epochRevealEndTime: string;
      _epochFinalizedTimestamp: string;
      _price: string;
      _lowRewardPrice: string;
      _highRewardPrice: string;
      _numberOfVotes: string;
      _votePowerBlock: string;
      _finalizationType: string;
      _trustedAddresses: string[];

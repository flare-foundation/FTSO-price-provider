...
export function priceHash(web3:any, ftsoIndices: (string | number | BN | BigNumber)[], prices: (string | number | BN | BigNumber)[], random: number | BN | BigNumber, address: string): string {
